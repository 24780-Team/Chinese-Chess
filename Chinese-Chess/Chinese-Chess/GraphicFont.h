...
public:
	ImpactFont() {
		dataFileName = "Resources/fonts/ImpactFont01.txt";
		imageFileName = "Resources/fonts/ImpactFont01.png";
		init();
	}
};
...
public:
	GaramondFont() {
		dataFileName = "Resources/fonts/GaramondFont01.txt";
		imageFileName = "Resources/fonts/GaramondFont01.png";
		init();
	}
};
...
public:
	JokermanFont() {
		dataFileName = "Resources/fonts/JokermanFont01.txt";
		imageFileName = "Resources/fonts/JokermanFont01.png";
		init();
	}
};
...
public:
	ComicSansFont() {
		dataFileName = "Resources/fonts/ComicSansFont01.txt";
		imageFileName = "Resources/fonts/ComicSansFont01.png";
		init();
	}
};
...
public:
	TimesNewRomanFont() {
		dataFileName = "Resources/fonts/TimesNewRomanFont01.txt";
		imageFileName = "Resources/fonts/TimesNewRomanFont01.png";
		init();
	}
};
...
public:
	OldEnglishFont() {
		dataFileName = "Resources/fonts/OldEnglishFont01.txt";
		imageFileName = "Resources/fonts/OldEnglishFont01.png";
		init();
	}
};
...
public:
	CourierNewFont() {
		dataFileName = "Resources/fonts/CourierNewFont01.txt";
		imageFileName = "Resources/fonts/CourierNewFont01.png";
		init();
	}
};
...
public:
	ArialFont() {
		dataFileName = "Resources/fonts/ArialFont01.txt";
		imageFileName = "Resources/fonts/ArialFont01.png";
		init();
	}
};
